...
CREATE TABLE `T_PROCESS_QUEUE` (
  ...
  `BATCH_GROUP_KEY` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL,
  `LAST_UPDATE_TIMESTAMP` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `LAST_UPDATE_USER` varchar(40) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `T_PROCESS_QUEUE_LOCK` (
  `PROCESS_KIND` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ORGANIZATION_ID` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `WORKSPACE_ID` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `GROUP_KEY` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL,
