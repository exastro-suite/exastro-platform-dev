...
(
  USER_ID VARCHAR(256) NOT NULL COMMENT 'User ID',
  AI_SERVICE_ID VARCHAR(64) NOT NULL COMMENT 'デフォルトで使用するAIサービスID: bedrock-cache, bedrock, openai, anthropic, etc.',
  ...
  LAST_UPDATE_USER VARCHAR(40) COMMENT '最終更新ユーザー',
  PRIMARY KEY (USER_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AIアシスタント ユーザー利用設定'
"""
