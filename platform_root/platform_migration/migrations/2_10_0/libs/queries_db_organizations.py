...
# AI Credential テーブル作成（オーガナイゼーション単位）
CREATE_TABLE_AI_CREDENTIAL = """
...
(
  ...
  AI_SERVICE_ID VARCHAR(64) NOT NULL COMMENT 'AIサービスID: bedrock, openai, anthropic, vertex, azure-openai, etc.',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='汎用AIサービスCredential'
"""
